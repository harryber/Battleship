...
var ASM_CONSTS = {
  3016228: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3016283: function($0) {performance.now = function() { return $0; };},  
 3016331: function($0) {performance.now = function() { return $0; };},  
 3016379: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3016434: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3016495: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3016559: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _setupEventListenerFromNative() {
      ...
      window.addEventListener("message", (event) => {
          ...
          SendMessage('GameController', 'ReceiveFromApp', event.data);
